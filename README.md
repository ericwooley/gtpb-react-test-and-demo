# DEMO FOR [graphql-typeorm-passport-boilerplate](https://github.com/ericwooley/graphql-typeorm-passport-boilerplate)
This is just to explore how to connect to the boilerplate from a react app.

# REACT APP BOILERPLATE README
